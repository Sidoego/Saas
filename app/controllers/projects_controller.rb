class ProjectsController < ApplicationController
  ...
  before_action :set_tenant, only: [:show, :edit, :update, :destory, :create , :new]
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :details, :expected_complition_date, :tenant_id)
    end
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant.id.to_s
        redirect_to :root, flash: { error: 'You are not autorized to access this project'}
      end
    end
